...
***Height/width have no effect on inline***
***Block can nest both inline and block elements***
...
***git can monitor adn control changes made across multiple people/teams***
